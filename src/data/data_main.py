...
def main():
    ...
    sqlite_file = input('Provide new filename to store database (ex. my_new_db.sqlite): ')
    api_key = 'Hv95pPh1xQWzt5DFhxS7'

    # Create the sqlite database tables
    print('\n.....Creating the sqlite database tables.....')
    ...
    print('\n.....Inserting data into Symbols table.....')
    ...
    print('\n.....Inserting data into Daily_Prices table.....')
